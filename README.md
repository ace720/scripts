...
1. [Script for empting folder contents.](../scripts/tempfile.sh)
...
2. [Script for managing installation and other services for Arch Linux.](../scripts/simpleAppsManager.sh) 
